...
#  
        ...
        # exp_size_int = _make_divisible(skip1_cfg[0] * skip1_cfg[1], round_nearest)
        # output_channel = _make_divisible(skip1_cfg[2] * width_mult, round_nearest)
        ...
        # output_channel = _make_divisible(skip2_cfg[2] * width_mult, round_nearest)
        # exp_size_int = _make_divisible(skip2_cfg[0] * skip2_cfg[1], round_nearest)
